        ...
        <div class="container d-flex align-items-center">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="#Admin_home">Admin Home</a></li>
            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                        ...
                        <center><h5><b> What To Do Admin Can?</b></h5></center>
                        <h6>
                            <ul>

                                <li>
                                    <p>Admin can Check Admins Deatils.</p>
                                </li>

                                <li>
                                    <p>Admin can Check Login Deatils.</p>
                                </li>

                                <li>
                                    <p>Admin can Check, Add, Edit & Delete Energy Programme Deatils.</p>
                                </li>

                                <li>
                                    <p>Admin can Check, Add, Edit & Delete Other Project Deatils.</p>
                                </li>

                                <li>
                                    <p>Admin can Add new Admin.</p>
                                </li>
