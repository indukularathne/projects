    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="#Other_Project">Other Projects</a></li>
      ...
      <div class="container">
        <div class="card">
          <div class="card-header">
            <h6>
              <center> Other Project Details</center>
              <h6>
                ...
                <div class="span12">
                  ...
                  <a href="othermodeladd.php" type="btn" class="btn btn-primary"> Click Here To Add </a>
                </div>
                ...
                <table id="datatableid" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT * FROM other_project ";
                    ...
                    ?>
                      <div id="createModal" class="modal" tabindex="-1" role="dialog">
                        <tr>
                          ...
                          <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row['project_cost']; ?>

                          <td style="text-align:center; width:350px;">

                            <a href="otheredit.php<?php echo '?id=' . $id; ?>" class="btn btn-info">Edit</a>
                            <a href="otherdlt.php<?php echo '?id=' . $id; ?>" class="btn btn-danger"> Delete</a>
                          </td>
