                                                    ...
                                                    <form class="form-horizontal" method="post" action=" <?php echo '?id=' . $ID; ?>" enctype="multipart/form-data" style="float: right;">
                                                        ...
                                                        <center>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <center>
                                                                    <p>
                                                                    <div style="font-size:larger;" class="alert alert-danger">Are you Sure you want Delete <b style="color:red;"><?php echo $row['schme'] . " " . $row['date'] . " " . $row['description'] . " " . $row['project_cost'] ; ?></b> Data?
                                                                    </div>
                                                                    </p>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <center>
                                                                            <a href="otherprojectAdmin.php" class="btn btn-inverse"> No</a>
                                                                            <a href="otherdelete.php<?php echo '?id=' . $id; ?>" class="btn btn-danger">Yes</a>
                                                                        </center>
                                                                    </div>
