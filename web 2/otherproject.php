    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="energyprogramme.php">Energy Programme</a></li>
          <li class="active"><a href="#Energy_Programme">Other Projects</a></li>
                      ...
                      ?>
                        <div id="createModal" class="modal" tabindex="-1" role="dialog">
                          ...
                          <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row['date']; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row['project_cost']; ?>  </td>                        </td>
