                                    ...
                                    <div class="hero-unit-3">
                                        <center>
                                            ...
                                            <form class="form-horizontal" method="post" action="edit_PDO.php<?php echo '?id=' . $ID; ?>" enctype="multipart/form-data" style="float: right;">
                                                <legend>
                                                    <h5>UPDATE ENERGY PROGRAMME DETAILS</h5>
                                                </legend>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="inputPassword">Annual Savings:</label>
                                                    <div class="controls">
                                                        <textarea rows="1" cols="50" name="annual_savings" required value=<?php echo $row['annual_savings']; ?>><?php echo $row['annual_savings']; ?></textarea>
                                                    </div>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            ...
                                            <center>
                                                ...
                                                <a href="energyprogrammeAdmin.php" class="btn">Back</a>
                                            </center>
                                        </div>
                                    </div>
