    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="#Energy_Programme">Energy Programme</a></li>
          <li><a href="otherproject.php">Other Projects</a></li>
          <li><a href="notifices_Update.html">Notices & Updates</a></li>
                      ...
                      ?>
                        <div id="createModal" class="modal" tabindex="-1" role="dialog">
                          ...
                          <td style="text-align:center; word-break:break-all; width:150px;"> <?php echo $row['date']; ?></td>
                            <td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row['schme'];
                                                                                                $id = $row['id'] ?></td>  
                            <td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row['description']; ?></td>
                            <td style="text-align:center; word-break:break-all; width:150px;"> <?php echo $row['project_cost']; ?></td>
                            <td style="text-align:center; word-break:break-all; width:150px;"> <?php echo $row['annual_savings']; ?>
