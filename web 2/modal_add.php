                                    ...
                                    <div class="hero-unit-3">
                                        <center>
                                                    ...
                                                    <form  method="post" action="add.php" enctype="multipart/form-data">
                                                        <center><h5>ADD NEW ENERGY PROGRAMME</h5></center>
                                                        <hr>
                                                        <table class="table1">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="30"></td>
                                                                <td><h1><textarea rows="5" cols="50" name="schme" required></textarea></h1></td>
                                                            </tr>
                                                            <tr>
                                                                <td><label style="color:#3a87ad; font-size:18px;">Date</label></td>
                                                                <td width="30"></td>
                                                                <td><h1><input type="date" r rows="5" cols="50" name="date" required></h1></td>
                                                            ...
                                                            <tr>
                                                                <td><label style="color:#3a87ad; font-size:18px;">Annual Savings</label></td>
                                                                <td width="30"></td>
                                                                <td><textarea rows="1" cols="50" name="annual_savings" required></textarea></td>
                                                            </tr>
                                                               <br>
                                                        ...
                                                        <center>
                                                                 <hr>
                                                                        ...
                                                                        <button class="btn"> <a href="energyprogrammeAdmin.php">Close</a></button>
